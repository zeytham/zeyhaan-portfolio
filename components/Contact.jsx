      ...
      <div className="max-w-6xl mx-auto px-6">
        ...
        >
          ...
          <p className="text-gray-500 mt-6 max-w-xl mx-auto leading-relaxed">
            Have a project in mind or want to collaborate? Feel free to reach out — I would love to hear from you.
          </p>
        </motion.div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
          ...
          >
            <div>
              <h3 className="text-xl font-bold text-gray-900 mb-6">Let us work together</h3>
              <p className="text-gray-500 leading-relaxed">
                I am available for freelance projects, collaborations, and consultations. Whether you need a website, a business system, data analysis, or technical documentation — I am here to help.
              </p>
            </div>
            ...
            <div className="space-y-4">
              <div className="flex items-center gap-4 p-4 bg-white border border-gray-100 rounded-2xl shadow-sm">
                ...
                <div>
                  ...
                  <a href="mailto:zeyanajuma204@gmail.com" className="text-sm font-medium text-gray-900 hover:text-green-700 transition-colors">
              ...
              <div className="flex items-center gap-4 p-4 bg-white border border-gray-100 rounded-2xl shadow-sm">
                ...
                <div>
                  <p className="text-xs text-gray-400 uppercase tracking-widest mb-0.5">Phone / WhatsApp</p>
                  <a href="tel:+255624945919" className="text-sm font-medium text-gray-900 hover:text-green-700 transition-colors">
                    +255 624 945 919
                  </a>
                </div>
              </div>
              ...
              <div className="flex items-center gap-4 p-4 bg-white border border-gray-100 rounded-2xl shadow-sm">
                ...
                <div>
                  ...
                  <p className="text-sm font-medium text-gray-900">Mwanakwerekwe, Zanzibar, Tanzania</p>
                </div>
              </div>
            </div>
            ...
            <div className="flex items-center gap-3 p-4 bg-green-50 border border-green-100 rounded-2xl">
              ...
              <p className="text-sm text-green-700 font-medium">Currently available for new projects and collaborations</p>
            </div>
          </motion.div>
